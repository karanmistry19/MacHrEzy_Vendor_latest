...
const DasboardCardComponent = ({
	...
	const [showTeamAttendanceDetails, setShowTeamAttendanceDetails] =
		useState(false);
	const [showMyAttendanceDetails, setShowMyAttendanceDetails] =
		useState(false);
	...
	const fetchAttendanceSum = (vv) => {
		...
		if (onAttendanceSummaryDateChange)
			onAttendanceSummaryDateChange(vv.value);
	};
								...
								<View style={{ marginBottom: 5 }}>
									<View style={styles.row}>
										...
										<Text style={styles.infoTextWithBold}>
											{`${
												teamAttendanceSummary?.presentEmp ||
												0
											}`}
										</Text>
									</View>
									...
									<View style={styles.row}>
										...
										<Text style={styles.infoTextWithBold}>
											{`${
												teamAttendanceSummary?.earlyOut ||
												0
											}`}
										</Text>
									</View>
									...
									<View style={styles.row}>
										...
										<Text style={styles.infoTextWithBold}>
											{`${
												teamAttendanceSummary?.incompleteHrs ||
												0
											}`}
										</Text>
									</View>
