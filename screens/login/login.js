...
import ChangePasswordMobile from "../../newComponents/ChangePassword/ChangePasswordMobile";
import RegisterUser from "../../newComponents/Register/RegisterUser";
import RegisterUserMobile from "../../newComponents/Register/RegisterUserMobile";
const Login = ({ login }) => {
	...
	const [registerMobileModalVisible, setRegisterMobileModalVisible] =
		useState(false);
		...
		>
			{width >= 550 ? (
				...
				<>
						...
						<View style={styles.mobContainer2}>
							...
							>
								...
								<Button
									...
									title={"Register"}
									onPress={() =>
										setRegisterMobileModalVisible(true)
									}
									// onPress={() =>
									// 	Linking.openURL(
									// 		"http://apps.macleods.in:8443/MacWeb/Mobile/Account/HRMSRegs.aspx",
					...
					{registerMobileModalVisible && (
						<RegisterUserMobile
							setRegisterMobileModalVisible={
								setRegisterMobileModalVisible
							}
						/>
					)}
...
const styles = StyleSheet.create({
	...
	boxContainer: {
		padding: 5,
		minHeight:
			Platform.OS === "android" || Platform.OS === "ios" ? 70 : null,
		maxHeight:
			Platform.OS === "android" || Platform.OS === "ios" ? 70 : null,
	},
	image: {
